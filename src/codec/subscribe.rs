...
impl Subscribe {
    pub(crate) fn from_buffer(
        ...
        while *offset < payload_end {
            topics.push(SubscribeTopic::from_buffer(buf, offset)?);
...
impl Unsubscribe {
    pub(crate) fn from_buffer(
        ...
        let mut topics = LimitedVec::new();
        while *offset < payload_end {
            topics.push(LimitedString::from(read_str(buf, offset)?));
...
impl Suback {
    pub(crate) fn from_buffer(
        ...
        while *offset < payload_end {
            return_codes.push(SubscribeReturnCodes::from_buffer(buf, offset)?);
